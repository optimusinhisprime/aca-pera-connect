...
async function firstTransaction() {
    ...
    try {
        let myAccount = "VTVQKJXDYFPHA3LOZDNLWAP3UIKV65SUIWLCW35AIEDYPESR36QUKQXYKI";
        ...
        accountInfo = await algodClient.accountInformation(myAccount).do();
